 ...
 * @author Me
 */
public class HotBootstrapper {

    public HotBootstrapper() {
    ...
    public List<String> getAvailableDeviceTypes() {
        ...
        try {
            String packageName = Device.class.getPackage().getName() + ".concretedevices";
            ...
            Logger.getLogger(HotBootstrapper.class.getName()).log(Level.SEVERE, null, ex);
        }
